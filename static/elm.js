...
var $author$project$Page$Home$TBC = {$: 'TBC'};
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Page$Home$init = _Utils_Tuple2($author$project$Page$Home$TBC, $elm$core$Platform$Cmd$none);
var $author$project$Page$Login$initForm = {password: '', reply: $elm$core$Maybe$Nothing, username: ''};
var $Janiczek$cmd_extra$Cmd$Extra$withNoCmd = function (model) {
	return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
};
var $author$project$Page$Login$init = $Janiczek$cmd_extra$Cmd$Extra$withNoCmd(
	{form: $author$project$Page$Login$initForm});
var $author$project$Page$Register$initForm = {confirm: '', password: '', reply: $elm$core$Maybe$Nothing, username: ''};
var $author$project$Page$Register$init = $Janiczek$cmd_extra$Cmd$Extra$withNoCmd(
	{form: $author$project$Page$Register$initForm});
...
var $author$project$Main$changeRouteTo = F2(
	function (maybeRoute, model) {
		var key = $author$project$Main$getKey(model);
			...
			switch (maybeRoute.a.$) {
				case 'Root':
					...
					return A2(
						...
						A2($author$project$Route$replaceUrl, key, $author$project$Route$Home),
						model);
				case 'Logout':
				...
				default:
					...
					return A3(
						...
						$author$project$Page$Register$init);
			}
		}
	});
...
var $author$project$Route$fromUrl = function (url) {
	...
	switch (_v0) {
		...
		case '/logout':
			return $elm$core$Maybe$Just($author$project$Route$Logout);
		case '/index':
			return $elm$core$Maybe$Just($author$project$Route$Home);
		case '/login':
			return $elm$core$Maybe$Just($author$project$Route$Login);
		case '/register':
			return $elm$core$Maybe$Just($author$project$Route$Register);
		default:
			return $elm$core$Maybe$Nothing;
	}
};
var $author$project$Main$init = F3(
	function (_v0, url, key) {
		return A2(
			...
			$author$project$Main$Redirect(key));
	});
	...
	switch (model.$) {
		...
		default:
			...
			return A2(
				$elm$core$Platform$Sub$map,
				$author$project$Main$GotRegisterMsg,
				$author$project$Page$Register$subscriptions(subModel));
	}
};
...
var $author$project$Page$Login$GotFormMsg = function (a) {
	return {$: 'GotFormMsg', a: a};
};
var $author$project$Page$Login$SentLogin = function (a) {
	return {$: 'SentLogin', a: a};
};
...
var $author$project$Api$encodeLoginInfo = function (form) {
...
var $author$project$Api$login = $author$project$Api$url(
	_List_fromArray(
		['login']));
var $elm$json$Json$Decode$field = _Json_decodeField;
var $author$project$Api$msgDecoder = A2($elm$json$Json$Decode$field, 'msg', $elm$json$Json$Decode$string);
...
var $author$project$Api$attemptLogin = F2(
	function (loginInfo, toMsg) {
		return $author$project$Api$post(
			{
				body: $elm$http$Http$jsonBody(
					$author$project$Api$encodeLoginInfo(loginInfo)),
				endpoint: $author$project$Api$login,
				expect: A2($elm$http$Http$expectJson, toMsg, $author$project$Api$msgDecoder)
			});
	});
	...
	function (msg, form) {
		switch (msg.$) {
			case 'SubmittedForm':
				return A2(
					$Janiczek$cmd_extra$Cmd$Extra$withCmd,
					A2($author$project$Api$attemptLogin, form, $author$project$Page$Login$SentLogin),
					form);
					...
					if (rs.a === 'Success') {
						...
						return $Janiczek$cmd_extra$Cmd$Extra$withNoCmd(
							_Utils_update(
								form,
								{
									reply: $elm$core$Maybe$Just(s)
								}));
					}
				} else {
					return $Janiczek$cmd_extra$Cmd$Extra$withNoCmd(form);
				}
		}
	});
var $author$project$Page$Login$update = F2(
	function (msg, model) {
		var m = msg.a;
		var _v1 = A2($author$project$Page$Login$updateForm, m, model.form);
		var form_ = _v1.a;
		var formMsg_ = _v1.b;
		return A2(
			$Janiczek$cmd_extra$Cmd$Extra$withCmd,
			A2($elm$core$Platform$Cmd$map, $author$project$Page$Login$GotFormMsg, formMsg_),
			_Utils_update(
				model,
				{form: form_}));
	});
var $author$project$Page$Register$GotFormMsg = function (a) {
	return {$: 'GotFormMsg', a: a};
};
var $author$project$Page$Register$SentRegister = function (a) {
	return {$: 'SentRegister', a: a};
};
var $author$project$Page$Register$encode = function (form) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				...
				_Utils_Tuple2(
				'confirm',
				$elm$json$Json$Encode$string(form.confirm))
			]));
};
var $author$project$Api$register = $author$project$Api$url(
	_List_fromArray(
		['register']));
var $author$project$Page$Register$login = function (form) {
	return $author$project$Api$post(
		{
			body: $elm$http$Http$jsonBody(
				$author$project$Page$Register$encode(form)),
			endpoint: $author$project$Api$register,
			expect: A2($elm$http$Http$expectJson, $author$project$Page$Register$SentRegister, $author$project$Api$msgDecoder)
		});
};
	...
	function (msg, form) {
		switch (msg.$) {
			case 'SubmittedForm':
				return A2(
					$Janiczek$cmd_extra$Cmd$Extra$withCmd,
					$author$project$Page$Register$login(form),
					form);
			case 'EnteredUsername':
				var s = msg.a;
				return $Janiczek$cmd_extra$Cmd$Extra$withNoCmd(
...
var $author$project$Page$Register$update = F2(
	function (msg, model) {
		var m = msg.a;
		var _v1 = A2($author$project$Page$Register$updateForm, m, model.form);
		var form_ = _v1.a;
		var formMsg_ = _v1.b;
		return A2(
			$Janiczek$cmd_extra$Cmd$Extra$withCmd,
			A2($elm$core$Platform$Cmd$map, $author$project$Page$Register$GotFormMsg, formMsg_),
			_Utils_update(
				model,
				{form: form_}));
	});
				...
				default:
					if (_v0.b.$ === 'Register') {
						...
						return A3(
							...
							$author$project$Main$GotRegisterMsg,
							$author$project$Main$Register(key),
							A2($author$project$Page$Register$update, subMsg, subModel));
					} else {
						break _v0$5;
					}
			}
...
var $author$project$Page$Login$EnteredUsername = function (a) {
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Events$onInput($author$project$Page$Login$EnteredUsername),
...
var $author$project$Page$Register$EnteredConfirm = function (a) {
	return {$: 'EnteredConfirm', a: a};
};
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Events$onInput($author$project$Page$Register$EnteredConfirm),
										$elm$html$Html$Attributes$value(form.confirm),
										$elm$html$Html$Attributes$type_('password')
									]),
								_List_Nil)
							]))
		...
		content: A2(
			...
			_List_fromArray(
				[
					A2(
					$elm$html$Html$map,
					$author$project$Page$Register$GotFormMsg,
